...
@click.command()
@click.option('-s', '--slot', required=True, type=int, help='The slot to extract block')
...
@click.command()
@click.option('-e', '--epoch', required=True, type=int, help='The epoch to extract committee')
