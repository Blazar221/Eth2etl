...
class slashinga:
	...
	def csv_line(self):
		return (*self.indice1, self.slot1, self.cmt_index1, self.block_root1, self.src_epoch1, self.src_root1, self.trgt_epoch1, self.trgt_root1, self.sign1, *self.indice2, self.slot2, self.cmt_index2, self.block_root2, self.src_epoch2, self.src_root2, self.trgt_epoch2, self.trgt_root2, self.sign2)


class slashingp:
	def __init__(self, block_root, vld1, slot1, parent_root1, state_root1, body_root1, sign1, vld2, slot2, parent_root2, state_root2, body_root2, sign2):
		self.block_root = block_root
		self.vld1 = vld1
		self.vld2 = vld2
		self.slot1 = slot1
	...
	def csv_line(self):
		return (self.slot1, self.vld1, self.parent_root1, self.state_root1, self.body_root1, self.sign1, self.slot2, self.vld2, self.parent_root2, self.state_root2, self.body_root2, self.sign2)
...
class committee:
	...
	def csv_line(self):
		...
		return (epoch, time_tool.get_timestamp_epoch(epoch), self.slot, self.index, *self.indices)	
